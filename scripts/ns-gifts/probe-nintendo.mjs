/**
 * Standalone NS.gifts Nintendo eShop gift-card discovery probe — run ON THE WHITELISTED VPS.
 *
 ...
 *
 *   node scripts/ns-gifts/probe-nintendo.mjs
 *
...
// Nintendo eShop gift cards — list everything Nintendo-looking.
const RX = /nintendo|eshop|switch/i;
const EXCLUDE = /online|membership|subscription/i;
