/**
 * Standalone NS.gifts Apple App Store & iTunes gift-card discovery probe — run ON THE WHITELISTED VPS.
 *
 ...
 *
 *   node scripts/ns-gifts/probe-apple.mjs
 *
...
// Apple App Store & iTunes gift cards — list everything Apple-looking.
const RX = /apple|itunes|app store/i;
const EXCLUDE = /music|tv+|arcade|icloud/i;
